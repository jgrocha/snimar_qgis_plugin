...
from EditorMetadadosSNIMar.snimarQtInterfaceView.pyuic4GeneratedSourceFiles import qualityPanel
...
class QualityWidget(qgui.QWidget, qualityPanel.Ui_quality):
    def __init__(self, parent, scope):
        ...
        self.conformancedatetype.setModel(
                customCombo.CustomComboBoxModel(self, [None] + sorted(
                        self.combo_items_ci_datetypecode.values(),
